...
public class ItemGetter : MonoBehaviour
{
    ...
    public void GetItems()
    {
        ...
        SP.GenerateItemsAtLocation(ItemSystemGameData.SessionID.ToString(), "Session", 0, ItemSystemGameData.AppID, minEnergy, MaxEnergy, OnReceivedGeneratedItems, andTagsString);
    }
