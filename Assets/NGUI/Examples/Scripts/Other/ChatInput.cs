...
public class ChatInput : MonoBehaviour
{
	...
	/// <summary>
	/// Pressing 'enter' should immediately give focus to the uiInput field.
	/// </summary>
	...
	/// <summary>
	/// Submit notification is sent by UIInput when 'enter' is pressed or iOS/Android keyboard finalizes uiInput.
	/// </summary>
	...
	public void OnSubmit ()
	{
		if (textList != null)
		{
			// It's a good idea to strip out all symbols as we don't want user uiInput to alter colors, add new lines, etc
