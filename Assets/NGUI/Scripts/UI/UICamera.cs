...
/// - OnKey (KeyCode key) is sent when keyboard or controller uiInput is used.
/// </summary>
...
public class UICamera : MonoBehaviour
{
	...
	/// <summary>
	/// Whether the mouse uiInput is used.
	/// </summary>

	public bool useMouse = true;

	/// <summary>
	/// Whether the touch-based uiInput is used.
	/// </summary>
	...
	/// <summary>
	/// Custom uiInput processing logic, if desired. For example: WP7 touches.
	...
	/// <summary>
	/// Whether an uiInput field currently has focus.
	/// </summary>
	...
	// Mouse uiInput is turned off on iOS
	Camera mCam = null;
	...
	/// <summary>
	/// Generic notification function. Used in place of SendMessage to shorten the caseCode and allow for more than one receiver.
	/// </summary>
	...
	/// <summary>
	/// Update the object under the mouse if we're not using touch-based uiInput.
	/// </summary>
	...
	/// <summary>
	/// Check the uiInput and send out appropriate events.
	/// </summary>
	...
	void Update ()
	{
		...
		// Update mouse uiInput
		if (useMouse || (useTouch && mIsEditor)) ProcessMouse();

		// Process touch uiInput
		if (useTouch) ProcessTouches();

		// Custom uiInput processing
		if (onCustomInput != null) onCustomInput();

		// Clear the selection on the cancel key, but only if mouse uiInput is allowed
		...
		// Forward the uiInput to the selected object
		if (mSel != null)
		{
	...
	public void ProcessTouches ()
	{
		for (int i = 0; i < Input.touchCount; ++i)
		{
			...
			{
				// Although uiInput.deltaPosition can be used, calculating it manually is safer (just in case)
	...
	public void ProcessOthers ()
	{
		...
		// If this is an uiInput field, ignore WASD and Space key presses
