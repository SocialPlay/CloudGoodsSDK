...
public class UIInput : UIWidgetContainer
{
	...
	/// <summary>
	/// Current uiInput, available inside OnSubmit callbacks.
	/// </summary>
	...
	/// <summary>
	/// Maximum number of characters allowed before uiInput no longer works.
	/// </summary>
	...
	/// <summary>
	/// Whether this uiInput field should hide its text.
	/// </summary>
	...
	/// <summary>
	/// Whether the label's text value will be used as the uiInput's text value on start.
	...
	/// value of the uiInput field will remain empty.
	/// </summary>

	public bool useLabelTextAtStart = false;

	/// <summary>
	/// Color of the label when the uiInput field has focus.
	/// </summary>
	...
	/// <summary>
	/// Callbacks triggered when the uiInput field submits the text.
	/// </summary>
	...
	/// <summary>
	/// Whether the uiInput is currently selected.
	/// </summary>
	...
	/// <summary>
	/// Set the default text of an uiInput.
	/// </summary>
	...
	/// <summary>
	/// Labels used for uiInput shouldn't support color encoding.
	/// </summary>
	...
	void OnInput (string input)
	{
		...
		{
			// Mobile devices handle uiInput in Update()
	...
	/// <summary>
	/// Submit the uiInput field's text.
	/// </summary>
	...
	void Append (string input)
	{
		for (int i = 0, imax = input.Length; i < imax; ++i)
		{
			...
			else if (c == '\r' || c == '\n')
			{
				...
				{
					// Not multi-line uiInput, or control isn't held
				...
				// If we have an uiInput validator, validate the uiInput first
				if (validator != null) c = validator(mText, c);

				// If the uiInput is invalid, skip it
				if (c == 0) continue;
			...
			else if (c >= ' ')
			{
				...
				// Append the character and notify the "uiInput changed" listeners.
				mText += c;
				SendMessage("OnInputChanged", this, SendMessageOptions.DontRequireReceiver);
			}
		}
	...
	/// <summary>
	/// Restore the uiInput label's pivot point and position.
	/// </summary>
